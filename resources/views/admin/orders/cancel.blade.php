...
@endphp
@section('title') 
@if($settings->site_name) Cancel Orders | {{$settings->site_name}} @else Cancel Orders | {{config('app.name')}}  @endif
@endsection
...
<div class="sl-pagebody">
    ...
    @isset(auth()->user()->role->permission['permission']['order']['list'] )
        <div class="col-lg-12 col-md-12 col-sm-12" >
            <div class="card ">
                <h6 class="card-header text-center">Cancel Orders List</h6>
                <div class="card-body">
                        ...
                        <table id="datatable1" class="table display responsive wrap">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><strong class="badge badge-pill badge-danger" style="padding: 5px 10px;">{{ $data->status }}</strong></td>
                                    <td>
                                        <h4 class="row" style="justify-content: center;">
                                            ...
                                            @isset(auth()->user()->role->permission['permission']['order']['delete'] )    
                                                <a href="{{url('admin/order/delete/'.$data->id)}}" id="delete"><i class="fa fa-trash text-danger" title="Delete"></i></a>
                                            @endisset
                                        </h4>
                                    </td>
                                </tr>

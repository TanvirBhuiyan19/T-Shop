...
@endphp
@section('title') 
@if($settings->site_name) Confirmed Orders | {{$settings->site_name}} @else Confirmed Orders | {{config('app.name')}}  @endif
@endsection
...
<div class="sl-pagebody">
    ...
    @isset(auth()->user()->role->permission['permission']['order']['list'] )
        <div class="col-lg-12 col-md-12 col-sm-12" >
            <div class="card ">
                <h6 class="card-header text-center">Confirmed Orders List</h6>
                <div class="card-body">
                        ...
                        <table id="datatable1" class="table display responsive wrap">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><strong class="badge badge-pill badge-success" style="padding: 5px 10px;">{{ $data->status }}</strong></td>
                                    <td>

  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <a href="{{config('app.url')}}" style="text-decoration: none;"><h2 style="color: green; font-size: 26px;">
            <strong> @if($settings->site_name) {{$settings->site_name}} @else {{config('app.name')}}  @endif</strong>
          </h2></a>
        </td>
    ...
    <tbody>
     ...
     <tr class="font">
        <td align="center" style="border-bottom: 1px solid;padding-bottom: 5px;">
            <img src="{{ public_path('uploads/product/thumbnail/') }}/{{$item->product->product_thumbnail}}" height="50px;" width="50px;" alt="">
        </td>

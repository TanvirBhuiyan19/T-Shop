...
@endphp
@section('title') 
@if($settings->site_name) Pending Orders | {{$settings->site_name}} @else Pending Orders | {{config('app.name')}}  @endif
@endsection
...
<div class="sl-pagebody">
    ...
    @isset(auth()->user()->role->permission['permission']['order']['list'] )
        <div class="col-lg-12 col-md-12 col-sm-12" >
            <div class="card ">
                <h6 class="card-header text-center">Pending Orders List</h6>
                <div class="card-body">

...
@endphp
@section('title') 
@if($settings->site_name) Edit Division | {{$settings->site_name}} @else Edit Division | {{config('app.name')}}  @endif
@endsection
...
<nav class="breadcrumb sl-breadcrumb">
    ...
    <a class="breadcrumb-item" href="{{route('division')}}">Divisions</a>
...
<div class="sl-pagebody">
    <div class="row row-sm">     
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 m-auto" >
            <div class="card ">
                <h6 class="card-header text-center">Edit Division</h6>
                <div class="card-body">
                    <form method="POST" action="{{ route('division.update') }}" >
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                ...
                                <input class="form-control" type="text" name="division_name_en" value="{{ $division->division_name_en }}">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                ...
                                <input class="form-control" type="text" name="division_name_bn" value="{{ $division->division_name_bn }}">
                        ...
                        <div class="form-layout-footer mg-t-10">
                            ...
                            <button class="btn btn-success btn-block">Update Division</button>

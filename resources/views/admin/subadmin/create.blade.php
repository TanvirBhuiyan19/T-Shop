...
@section('subadmin.create') active @endsection
...
@endphp
@section('title') 
@if($settings->site_name) Add Subadmin | {{$settings->site_name}} @else Add Subadmin | {{config('app.name')}}  @endif
@endsection
...
<nav class="breadcrumb sl-breadcrumb">
    ...
    <span class="breadcrumb-item active">Add Subadmin</span>
</nav>
...
<div class="sl-pagebody">
    <div class="row row-sm">
        ...
        <!--<!------------------------ Subadmin Create Form ----------------------------------------------->         
        <div class="col-lg-10 col-md-10col-sm-12 m-auto" >
            <div class="card ">
                <h5 class="card-header text-center">Add Subadmin </h5>
                <div class="card-body">
                    <form method="POST" action="{{ route('subadmin.store') }}" >
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Password') }}<span class="tx-danger">*</span></label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}<span class="tx-danger">*</span></label>
                        ...
                        <input type="hidden" name="image" value="avatar556589552.jpg">

    ...
    <div class="container">
        <div class="breadcrumb-inner">
            <ul class="list-inline list-unstyled">
                ...
                <li class='active'>{{$brand->brand_name_bn}}</li>
                @else
                <li><a href="{{url('/')}}">Home</a></li>
                <li class='active'>{{$brand->brand_name_en}}</li>
                @endif
            </ul>
                ...
                <div class="clearfix filters-container m-t-10">
                    <div class="row">
                        ...
                        <div class="col col-sm-6 col-md-4 col-lg-4 text-right">
                            ...
                            {{ $brand_wise_products->appends($_GET)->links('vendor.pagination.custom') }}
                        ...
                        <div class="tab-pane active " id="grid-container">
                            <div class="category-product">
                                <div class="row">									
                                    ...
                                    @forelse($brand_wise_products as $product)
...
@section('scripts')
    ...
    <script>
            $('#sortBy').change(function(e) {
                ...
                window.location = "{{ url('' . $route . '') }}/{{ $brandSlug }}?sortBy="+sortBy;
            });
        </script>
@endsection
...
@endphp
@section('title')  
@if(session()->get('language') == 'bangla') {{$color_name}} @else {{$color_name}} @endif 
                ...
                <div class="clearfix filters-container m-t-10">
                    <div class="row">
                        ...
                        <div class="col col-sm-6 col-md-4 col-lg-4 text-right">
                            {{ $color_wise_products->appends($_GET)->links('vendor.pagination.custom') }}		
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div>
                        ...
                        <div class="tab-pane active " id="grid-container">
                            <div class="category-product">
                                <div class="row">									
                                    ...
                                    @forelse($color_wise_products as $product)
...
@section('scripts')
    ...
    <script>
            $('#sortBy').change(function(e) {
                ...
                window.location = "{{ url('' . $route . '') }}/{{ $color_name }}?sortBy="+sortBy;
            });
        </script>
@endsection
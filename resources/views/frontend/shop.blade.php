...
@endphp
@section('title')  
@if(session()->get('language') == 'bangla') শপ @else Shop @endif 
                ...
                <div class='col-md-3 sidebar'>
                    ...
                    <div class="sidebar-module-container">
                        <div class="sidebar-filter">
                            @include('frontend.include.leftbar.shop-by')
                            <br><br>
                        </div><!-- /.sidebar-filter -->
                                    ...
                                    <div class="lbl-cnt">
                                        <div class="fld inline">
                                            <div class="dropdown dropdown-small dropdown-med dropdown-white inline">
                                                <select class="form-control lbl" name="sortBy" id="sortBy" onchange="this.form.submit();" style="width: auto; height: auto;">
                                                    <option disabled selected >Sort by Product</option>
                                                    <option value="priceLowesttoHighest" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'priceLowesttoHighest') selected @endif >Price: Lowest to HIghest</option>
                                                    <option value="priceHighesttoLowest" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'priceHighesttoLowest') selected @endif >Price: HIghest to Lowest</option>
                                                    <option value="nameAtoZ" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'nameAtoZ') selected @endif >Name: A to Z</option>
                                                    <option value="nameZtoA" @if (!empty($_GET['sortBy']) && $_GET['sortBy'] == 'nameZtoA') selected @endif >Name: Z to A</option>
                                                </select>
                                            </div>
                                        </div><!-- /.fld -->
                                    </div><!-- /.lbl-cnt -->

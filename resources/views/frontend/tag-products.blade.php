...
@endphp
@section('title')  
@if(session()->get('language') == 'bangla') {{$tag_name}} @else {{$tag_name}} @endif 
                ...
                <div class="clearfix filters-container m-t-10">
                    <div class="row">
                        ...
                        <div class="col col-sm-6 col-md-4 col-lg-4 text-right">
                           {{ $tag_wise_products->appends($_GET)->links() }}	                           		
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div>
                        ...
                        <div class="tab-pane active " id="grid-container">
                            <div class="category-product">
                                <div class="row">									
                                    ...
                                    @forelse($tag_wise_products as $product)
...
@section('scripts')
    ...
    <script>
            $('#sortBy').change(function(e) {
                ...
                window.location = "{{ url('' . $route . '') }}/{{ $tag_name }}?sortBy="+sortBy;
            });
        </script>
@endsection